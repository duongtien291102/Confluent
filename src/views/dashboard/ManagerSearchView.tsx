        ...
        <div ref={containerRef} className="relative">
            <div className="relative">
                <input
                    ...
                    className="w-full px-4 py-2.5 pr-10 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F79E61]/50 focus:border-[#F79E61] transition-all"
                />
